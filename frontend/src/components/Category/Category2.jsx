        ...
        <div className='container'>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {/* First col */}
                ...
                {/* Second col */}
                <div className='py-10 pl-5 bg-gradient-to-br from-brand-green 90 to-brand-green/90
                ...
                {/* Third col */}
                <div className='py-10 pl-5 bg-gradient-to-br from-brand-blue to-brand-blue/90
                text-white rounded-3xl relative h-[320px] flex items-start'>
                  <div>
                    <div className='mb-4'>
                      <p className='mb-[2px] text-white'>Enjoy</p>
