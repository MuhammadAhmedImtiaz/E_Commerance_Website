    ...
    <div className='min-h-[550px] flex justify-center items-center py-12'>
      <div  className='container'>
        ...
        <div className='p-6 sm:p-8 '>
          ...
          <h1 data-aos="zoom-out" className='uppercase text-4xl lg:7xl font-bold'>{" "}{data.title}</h1>
          <p  data-aos="fade-up" className='text-sm'>{data.date}</p>
        </div>
        {/* second col */}
        <div data-aos="zoom-in" className='h-full flex items-center'>
      
          <img src={data.image} alt="" className='scale-125 w-[250px] md:w-[240px] mx-auto drop-shadow-2xl
          object-cover' />
        </div>
        {/* third col */}
